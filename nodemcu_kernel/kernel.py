...
from .nodemcu import connect

__version__ = '0.1'

class NodeMcuKernel(Kernel):
    implementation = 'nodemcu_kernel'
    ...
    help_links = [
        {'text': 'NodeMcu MicroPython',
         'url': 'https://docs.micropython.org/en/latest/esp8266/index.html'
        },
    ]

    banner = "Welcome to MicroPython on the NodeMcu"
